...
* **init:** preserve `settings.json` symlinks when patching hooks and write portable hook command paths in `settings.json` ([#653](https://github.com/rtk-ai/rtk/issues/653))
