...
* **security(tee):** restrict tee file permissions to `0600` and tee directory to `0700` on Unix — tee files may contain sensitive command output (tokens, credentials in error messages); hint message updated to note this
