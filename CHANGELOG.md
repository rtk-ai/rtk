...
## [0.37.0](https://github.com/rtk-ai/rtk/compare/v0.36.0...v0.37.0) (2026-05-13)


### Features

* **cicd:** add auto next release parser ([bf24972](https://github.com/rtk-ai/rtk/commit/bf24972e7d463f0432b8315e3035e9eb13ff062f))
* **cicd:** add auto next release parser ([f3e33f3](https://github.com/rtk-ai/rtk/commit/f3e33f38872008fe0046e2e139a6762845504b8e))
...
* **gradlew:** add Gradle/gradlew support with streaming filters ([71d285f](https://github.com/rtk-ai/rtk/commit/71d285fc42d2a97d6d1472bb96fff2db9ab39bab))
...
* **init:** add --dry-run flag to preview changes without writing ([21a069a](https://github.com/rtk-ai/rtk/commit/21a069ad76c3d8ffeee870d24408b1942cee691c))
...
* **discover:** skip head/tail rewrite when multiple files are passed ([#1362](https://github.com/rtk-ai/rtk/issues/1362)) ([ec3a4e9](https://github.com/rtk-ai/rtk/commit/ec3a4e96fdcda6592afb08fb0ad0afaf41e07385))
* **discover:** weighted savings rate per bucket, decimal already_rtk percent ([82c62eb](https://github.com/rtk-ai/rtk/commit/82c62eb893966b8f170ea22ec72e79f14789e12e))
...
* **gradlew:** satisfy semgrep dynamic-command-execution rule ([36ec02d](https://github.com/rtk-ai/rtk/commit/36ec02d132731dbed41dcf4d124bf957f06695d0))
...
* grep false negatives, output mangling, and truncation annotations ([9bdf435](https://github.com/rtk-ai/rtk/commit/9bdf435e8de3a24be213b5d5ab359bd8e7737923))
...
* **grep:** adjust the command to fall through if the output would already be as small as possible ([021827c](https://github.com/rtk-ai/rtk/commit/021827c3c9965f6dd4059edc380b1a605b322f39))
...
* **install:** resolve version via redirect to avoid API rate limits ([f67ae3b](https://github.com/rtk-ai/rtk/commit/f67ae3bcd2b1f0f843b969c3800ee6bf751894f4))
...
* **ls:** add LC_ALL=C and fallback to raw on unrecognized locale ([0d70760](https://github.com/rtk-ai/rtk/commit/0d70760ef98749203dbaeaebe2323169436afdf3))
* **ls:** distinguish empty dir from unparseable locale content ([25727e3](https://github.com/rtk-ai/rtk/commit/25727e343dd0eb6727d890e0e13dc53dfa08148c))
...
* **ls:** LC_ALL=C + fallback to raw on unrecognized locale ([b51a815](https://github.com/rtk-ai/rtk/commit/b51a815451c18b935633f6690e6c3b93a29b97f8))
...
* **tests:** update init.rs test calls for dry_run parameter ([add1464](https://github.com/rtk-ai/rtk/commit/add14643886e1b2c5450056433e577c003872e4d))
