...
rtk init -g --agent workbuddy --auto-patch # WorkBuddy desktop (global)
...
| **WorkBuddy** | `rtk init -g --agent workbuddy` | Native `PreToolUse` hook in `~/.workbuddy/settings.json`; [details](hooks/workbuddy/README.md) |
