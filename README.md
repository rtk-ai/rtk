...
rtk init --cursor           # Cursor: project .cursor/hooks + rules
rtk init --cursor -g        # Cursor: global ~/.cursor/
rtk init --cursor --show    # Cursor: show status
```

After install, **restart Claude Code** (or Cursor).
