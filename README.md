...
rtk init --agent continue       # Continue.dev (project)
rtk init -g --agent continue    # Continue.dev (global)
...
| **Continue.dev** | `rtk init --agent continue` (or `-g`) | .continue/rules/rtk.md |
