...
1. Raw unfiltered output is stored in a content-addressed sqlite database (`~/.local/share/rtk/recall.db`, lz4, byte-faithful up to `max_entry_bytes`; larger output is truncated at a line boundary)
