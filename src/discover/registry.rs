...
use super::lexer::{
    ...
    is_crlf_at, is_word_boundary_whitespace, opens_substitution, redirect_has_file_target,
    shell_split, split_for_classify, split_for_permissions, tokenize, tokenize_with_newlines,
};
