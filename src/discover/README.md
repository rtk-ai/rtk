...
| `split_on_chain_operators(cmd)` | Splits chains while preserving complete pipelines for classification — not safe for permission/security decisions | `registry.rs::split_command_chain` |
