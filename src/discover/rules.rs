...
pub const RULES: &[RtkRule] = &[
    ...
    RtkRule {
        pattern: r"^((p?np(m|x)|p?npm\s+(exec|run|run-script)|npm\s+(rum|urn|x)|pnpm\s+dlx)\s+)?biome(\s|$)",
        rtk_cmd: "rtk lint biome",
        rewrite_prefixes: &[
            "biome",
            "npm biome",
            "npm exec biome",
    ...
    RtkRule {
        pattern: r"^((p?np(m|x)|p?npm\s+(exec|run|run-script)|npm\s+(rum|urn|x)|pnpm\s+dlx)\s+)?eslint(\s|$)",
        rtk_cmd: "rtk lint eslint",
        rewrite_prefixes: &[
            "eslint",
            "npm eslint",
            "npm exec eslint",
    ...
    RtkRule {
        pattern: r"^((p?np(m|x)|p?npm\s+(exec|run|run-script)|npm\s+(rum|urn|x)|pnpm\s+dlx)\s+)?lint(\s|$)",
        rtk_cmd: "rtk lint",
        rewrite_prefixes: &[
            "lint",
            "npm lint",
