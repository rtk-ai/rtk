...
pub const RULES: &[RtkRule] = &[
    ...
    RtkRule {
        ...
        rtk_cmd: "rtk mypy",
        rewrite_prefixes: &["uv run python3 -m mypy", "uv run python -m mypy", "uv run mypy", "python3 -m mypy", "python -m mypy", "mypy"],
        category: "Build",
        savings_pct: 80.0,
        subcmd_savings: &[],
        subcmd_status: &[],
    ...
    RtkRule {
        pattern: r"^(uv\s+run\s+)?(python\s+-m\s+)?pytest(\s|$)",
        rtk_cmd: "rtk pytest",
        rewrite_prefixes: &["uv run python -m pytest", "uv run pytest", "python -m pytest", "pytest"],
        category: "Python",
        savings_pct: 90.0,
        subcmd_savings: &[],
        subcmd_status: &[],
