...
pub const RULES: &[RtkRule] = &[
    ...
    RtkRule {
        pattern: r"^pactl\s+(list|info)\b",
        rtk_cmd: "rtk pactl",
        rewrite_prefixes: &["pactl"],
        category: "System",
        savings_pct: 65.0,
        subcmd_savings: &[("list", 70.0), ("info", 60.0)],
        subcmd_status: &[],
    },
    RtkRule {
        pattern: r"^xrandr\b",
        rtk_cmd: "rtk xrandr",
        rewrite_prefixes: &["xrandr"],
        category: "System",
        savings_pct: 60.0,
        subcmd_savings: &[],
        subcmd_status: &[],
    ...
    RtkRule {
        pattern: r"^crontab\s+-l\b",
        rtk_cmd: "rtk crontab",
        rewrite_prefixes: &["crontab"],
        category: "System",
        savings_pct: 60.0,
        subcmd_savings: &[],
        subcmd_status: &[],
