...
pub const RULES: &[RtkRule] = &[
    ...
    RtkRule {
        pattern: r"^powershell\.exe(?:\s|$)",
        rtk_cmd: "rtk powershell --executable powershell.exe",
        rewrite_prefixes: &["powershell.exe"],
        category: "Infra",
        savings_pct: 65.0,
        subcmd_savings: &[],
        subcmd_status: &[],
    ...
    RtkRule {
        pattern: r"^pwsh(?:\s|$)",
        rtk_cmd: "rtk powershell --executable pwsh",
        rewrite_prefixes: &["pwsh"],
        category: "Infra",
        savings_pct: 65.0,
        subcmd_savings: &[],
        subcmd_status: &[],
    ...
    RtkRule {
        ...
        rtk_cmd: "rtk powershell --executable powershell",
        rewrite_prefixes: &["powershell"],
        category: "Infra",
        savings_pct: 65.0,
        subcmd_savings: &[],
        subcmd_status: &[],
