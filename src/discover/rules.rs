...
pub const RULES: &[RtkRule] = &[
    ...
    RtkRule {
        pattern: r"^ansible-galaxy\b",
        rtk_cmd: "rtk ansible-galaxy",
        rewrite_prefixes: &["ansible-galaxy"],
        category: "Infra",
        savings_pct: 65.0,
        subcmd_savings: &[],
        subcmd_status: &[],
    ...
    RtkRule {
        pattern: r"^ansible-lint\b",
        rtk_cmd: "rtk ansible-lint",
        rewrite_prefixes: &["ansible-lint"],
        category: "Build",
        savings_pct: 65.0,
        subcmd_savings: &[],
        subcmd_status: &[],
