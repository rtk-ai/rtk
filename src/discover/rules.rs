...
pub const RULES: &[RtkRule] = &[
    ...
    RtkRule {
        pattern: r"^p4\s+(describe|changes|diff|diff2|filelog|opened|files|fstat|annotate|edit|add|delete|revert|sync|submit|shelve|unshelve|resolve|move|lock|unlock)(\s|$)",
        rtk_cmd: "rtk p4",
        rewrite_prefixes: &["p4"],
        category: "Perforce",
        savings_pct: 85.0,
