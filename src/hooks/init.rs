...
use crate::hooks::constants::{
    ...
    CURSOR_DIR, GEMINI_DIR, GITHUB_DIR, KIRO_DIR, KIRO_HOOK_COMMAND, KIRO_HOOK_FILE,
    KIRO_HOOKS_SUBDIR, KIRO_STEERING_FILE, KIRO_STEERING_SUBDIR, OPENCODE_PLUGIN_FILE,
    OPENCODE_SUBDIR, PLUGIN_SUBDIR, TRAE_CN_DIR, TRAE_DIR, TRAE_RUN_COMMAND_MATCHER,
};
