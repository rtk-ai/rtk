...
fn print_manual_instructions(include_opencode: bool) {
...
fn patch_settings_json(
    ...
    match mode {
        PatchMode::Skip => {
            print_manual_instructions(include_opencode);
...
fn run_default_mode(
    ...
    // 1. Write RTK.md (hook is now built-in to rtk)
