...
use super::constants::{
    ...
    PRE_TOOL_USE_KEY, QODER_DIR, QODER_HOOK_COMMAND, QODER_SETTINGS_JSON, REWRITE_HOOK_FILE,
    SETTINGS_JSON,
};
use super::integrity;
...
/// Full uninstall for Claude, Gemini, Codex, Cursor, Pi, or Qoder artifacts.
pub fn uninstall(
    global: bool,
    gemini: bool,
    codex: bool,
