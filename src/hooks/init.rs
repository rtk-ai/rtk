...
use super::constants::{
    ...
    CRUSH_BASH_MATCHER, CRUSH_DIR, CRUSH_GLOBAL_CONFIG_ENV, CRUSH_HOOK_COMMAND, CRUSH_HOOK_NAME,
    CRUSH_LOCAL_RC_FILE, CRUSH_RC_FILE, CURSOR_HOOK_COMMAND, DROID_DIR, DROID_EXECUTE_MATCHER,
...
fn strip_crush_rtk_entries(content: &str) -> Option<String> {
    ...
    if removed { Some(output) } else { None }
}
