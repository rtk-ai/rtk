...
- **[`system/`](system/README.md)** — ls, tree, read, grep, find, wc, PowerShell, env, json, log, deps, summary, format, smart — format_cmd routing, filter levels, language detection
