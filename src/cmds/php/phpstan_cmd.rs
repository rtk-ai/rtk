...
// 鈹€鈹€ JSON structures matching PHPStan's --error-format=json output 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
// 鈹€鈹€ Public entry point 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
pub fn run(args: &[String], verbose: u8) -> Result<i32> {
    ...
    // Utility commands (--version, list, clear-result-cache, worker, 鈥?: real passthrough.
...
fn phpstan_run_options() -> runner::RunOptions<'static> {
...
enum ErrorFormat {
    /// No format flag 鈥?rtk injects `--error-format=json`.
    Unspecified,
    /// User explicitly asked for json 鈥?keep it, don't duplicate the flag.
    Json,
    /// User asked for a non-json format 鈥?leave args alone, use the text filter.
    Custom,
}
...
// 鈹€鈹€ JSON filtering 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
// 鈹€鈹€ Text fallback 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
mod tests {
    ...
    #[test]
    fn phpstan_failure_options_preserve_raw_diagnostics() {
        let options = phpstan_run_options();

        assert!(options.filter_stdout_only);
        assert!(options.skip_filter_on_failure);
        assert_eq!(options.tee_label, Some("phpstan"));
    }
    ...
    fn test_filter_phpstan_token_savings() {
        ...
        // to verify the 鈮?5% savings claim in rules.rs
        ...
        assert!(
            savings >= 60.0,
            "PHPStan: expected 鈮?0% savings, got {:.1}% (in={}, out={})",
            savings,
            input_tokens,
            output_tokens
        );
...
"#;
    ...
    fn test_filter_phpstan_text_error_summary_case_insensitive() {
        // phpstan prints "[ERROR] Found N errors" 鈥?capital F and no " in ",
    ...
    fn test_filter_phpstan_fixture_structure() {
        ...
        // Files are sorted by error count descending 鈥?User.php has 6, comes first
        assert!(output.contains("Models/User.php (6 errors)"));
        // 14 files 鈫?only 10 shown, 4 more
