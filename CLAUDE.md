...
- **Ruby Commands**: 2 modules for Ruby development
...
- **Architecture**: Standalone commands (rspec, rubocop)
- **Hook Integration**: Rewrites `rspec`, `rubocop`, `bundle exec` variants
