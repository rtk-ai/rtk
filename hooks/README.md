...
- **[`codex/`](codex/README.md)** — Native `PreToolUse` hook plus awareness document, `.codex/hooks.json` or `$CODEX_HOME/hooks.json`
...
| Codex CLI | `PreToolUse` command hook | `updatedInput.command` | Yes |
