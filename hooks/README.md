...
Owns: per-agent hook scripts and configuration files for 12 supported agents (Claude Code, Copilot, Cursor, Cline, Windsurf, Codex, OpenCode, MiniMax Code, Hermes, Pi, Oh My Pi (OMP), Mistral Vibe).
